...
public class XMemcachedProxy extends CachedProxyBase{
	...
	public long getCounter(String key) throws CachedException {
		try {
			...
			throw new com.b5m.cached.exception.TimeoutException(e, "getCounter", key);
		} catch (Exception e) {
	...
	public long increase(String key, long delta, long initValue)
		...
		try {
			...
			throw new com.b5m.cached.exception.TimeoutException(e, "increase", key);
		} catch (Exception e) {
			throw new CachedException(e);
		}
	}
	...
	public long decrease(String key, long delta, long initValue)
		...
		try {
			...
			throw new com.b5m.cached.exception.TimeoutException(e, "decrease", key);
		} catch (Exception e) {
			throw new CachedException(e);
		}
	}
	...
	protected void add(String key, Object value, long expiredTime,
		...
		try {
			if(!client.add(key, (int)expiredTime, value, writeTimeout)){
				throw new ExistsKeyException(key);
			}
		} catch (TimeoutException e) {
			throw new com.b5m.cached.exception.TimeoutException(e, "add", key);
	...
	public void delete(String key) throws CachedException {
		try {
			...
			throw new com.b5m.cached.exception.TimeoutException(e, "delete", key);
		} catch (InterruptedException e) {
			throw new CachedException(e);
		} catch (MemcachedException e) {
			throw new CachedException(e);
	...
	protected <T> T get(String key, Class<T> type, long retriveTimeout)
		...
		try {
			...
			if(null == value)
				throw new NonExistsKeyException(key);
			return type.cast(value);
		} catch (TimeoutException e) {
			throw new com.b5m.cached.exception.TimeoutException(e, "get", key);
		} catch (InterruptedException e) {
			throw new CachedException(e);
		} catch (MemcachedException e) {
			throw new CachedException(e);
	...
	public void remove(String key) throws CachedException {
		try {
			boolean flag = client.delete(key);
			if(!flag)
				throw new NonExistsKeyException(key);
		} catch (TimeoutException e) {
			throw new com.b5m.cached.exception.TimeoutException(e, "remove", key);
		} catch (InterruptedException e) {
			throw new CachedException(e);
		} catch (MemcachedException e) {
			throw new CachedException(e);
	...
	protected Map<String, Object> gets(List<String> keyCollections, long timeout) throws CachedException {
		try {
			...
			throw new com.b5m.cached.exception.TimeoutException(e, "gets", keyCollections.toString());
		} catch (InterruptedException e) {
			throw new CachedException(e);
		} catch (MemcachedException e) {
			throw new CachedException(e);
