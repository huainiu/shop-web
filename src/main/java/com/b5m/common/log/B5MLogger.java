...
public class B5MLogger {
	...
	public void logError(String errMsg) {
		logger.error(this.getMessage(errMsg,
	...
	public void logFatal(Exception e) {
		logger.fatal(this.getMessage(e.getMessage(),
				new Throwable().getStackTrace()[1].getMethodName()), e);
	...
	public void logError(Throwable e) {
		...
		logger.error(this.getMessage(e.getMessage(),
				new Throwable().getStackTrace()[1].getMethodName()), e);
