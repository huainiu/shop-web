...
public class ContextUtils implements ApplicationContextAware, DisposableBean {
	...
	public static WebApplicationContext getWebApplicationContext() {
		return (_applicationContext instanceof WebApplicationContext) ? (WebApplicationContext) _applicationContext
				: null;
	}
	...
	public final void _setServlet(HttpServletRequest request,
