...
<div id="error" class="w980">
    <!--err-hd s-->
    <div class="err-hd">
    	<h1 class="logo"><a href="${b5mUrl}"><img src="${basePath}images/images/logo_6.png" /></a></h1>
    </div>
    <!--err-hd e-->
    ...
    <div class="err-wrap">
        ...
        <div class="err-main">
        	<h2 class="err-result">您没有权限访问该页面</h2>
            <div class="err-operating">
                ...
                <ul>
                    ...
                    <li>
                        ...
                        <p><span>去其他地方逛逛</span><a href="${b5mUrl}">购物&gt;&gt;</a><a href="http://tiao.b5m.com">帮5挑&gt;&gt;</a></p>
                    </li>
                </ul>
            </div>
        </div>
