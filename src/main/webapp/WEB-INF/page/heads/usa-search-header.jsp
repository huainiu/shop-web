...
<%@ page session="false"%>
<link rel="stylesheet" href="http://staticcdn.b5m.com/css/haiwai/america/header.css?v=${today }">
<div class="top-hdbanner"></div>
<div class="tpbar"></div>
<div class="header">
	<div class="header-box cfx">
		<h1 class="header-logo fl">
			<a title="美国馆" href="/"><img src="http://staticcdn.b5m.com/images/logos/usa.png" alt="美国馆"></a>
		</h1>
		...
		<div class="header-tools-search" style="margin: 25px 0px 0px 33px;">
			<form action="http://usa.b5m.com" onsubmit="if(document.getElementById('scbar_txt').value=='')return false;form_submit()" autocomplete="off" method="get" name="scbar_form" id="scbar_form">
			...
			<script type="text/javascript">
				function form_submit() {
					...
					if (value != '') {
						...
						document.scbar_form.action = "http://usa.b5m.com/s/Search";
	...
	<div class="header-nav-box">
		<div class="wp">
			...
			<ul id="menu">
				...
				<li class=""><a data-attr="1004" href="http://usa.b5m.com/brand.html" target="_self">品牌库</a></li>
			</ul>
